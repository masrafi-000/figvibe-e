...
-- CreateEnum
CREATE TYPE "AuthProvider" AS ENUM ('GOOGLE', 'GITHUB', 'DISCORD', 'APPLE', 'PASSWORD');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'ACTIVE', 'INACTIVE', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "InventoryTransactionType" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'RESTOCK', 'DAMAGE', 'ADJUSTMENT', 'RESERVED', 'RELEASED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'PACKED', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'RETURNED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'STRIPE', 'BKASH', 'NAGAD', 'SSL_COMMERZ');
...
-- CreateIndex
CREATE UNIQUE INDEX "sizes_name_code_key" ON "sizes"("name", "code");
...
-- CreateIndex
CREATE UNIQUE INDEX "refresh_tokens_sessionToken_key" ON "refresh_tokens"("sessionToken");
